...
export function format(parsedNumber: ParsedNumber, format: 'International' | 'E.164' | 'National' | 'RFC3966'): string;
export function format(phone: TelephoneNumber, country: CountryCode, format: 'International' | 'E.164' | 'National' | 'RFC3966'): string;
