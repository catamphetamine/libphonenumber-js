...
describe('parse', () => {
	...
	it('should parse possible numbers', () => {
		...
		// Too long.
		expect(parseNumber('+7 (800) 55-35-35-555', { extended: true })).to.deep.equal({
			country            : undefined,
			countryCallingCode : '7',
			phone              : '00553535555',
			carrierCode        : undefined,
	...
	it('should work with Mexico numbers', () => {
		...
		expect(parseNumber('01 (449)978-0001', 'MX')).to.deep.equal({
			country: 'MX',
			phone: '4499780001'
		})
		...
		expect(parseNumber('+52 1 33 1234-5678', 'MX')).to.deep.equal({
			country: 'MX',
			phone: '3312345678'
		})
		...
		expect(parseNumber('044 (33) 1234-5678', 'MX')).to.deep.equal({
			country: 'MX',
			phone: '3312345678'
		})
		expect(parseNumber('045 33 1234-5678', 'MX')).to.deep.equal({
			country: 'MX',
			phone: '3312345678'
		})
	})
	...
	it('should parse non-geographic numbering plan phone numbers', () => {
		expect(parseNumber('+870773111632')).to.deep.equal({})
	})
})
