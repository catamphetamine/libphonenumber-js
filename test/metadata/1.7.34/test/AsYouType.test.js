...
describe('as you type', () => {
	...
	it('should format non-geographic numbering plan phone numbers', () => {
		...
		expect(formatter.input('7')).to.equal('+870 7 7')
		expect(formatter.input('3')).to.equal('+870 7 73')
		expect(formatter.input('1')).to.equal('+870 7 731')
		expect(formatter.input('1')).to.equal('+870 7 7311')
		expect(formatter.input('1')).to.equal('+870 7 7311 1')
		expect(formatter.input('6')).to.equal('+870 7 7311 16')
		expect(formatter.input('3')).to.equal('+870 7 7311 163')
		expect(formatter.input('2')).to.equal('+870 7 7311 1632')
	})
