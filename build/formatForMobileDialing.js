...
exports.default = function (number, from_country, with_formatting, metadata) {
	...
	if (country === from_country) {
		...
		if (country === 'CO' && number_type === 'FIXED_LINE') {
			...
			formatted_number = metadata.nationalPrefix() + ' ' + (0, _format2.default)(number, 'NATIONAL', metadata.metadata);
			...
			(country === 'MX' || country === 'CL') && is_fixed_line_or_mobile) && can_be_internationally_dialled(number)) {
...
//# sourceMappingURL=formatForMobileDialing.js.map